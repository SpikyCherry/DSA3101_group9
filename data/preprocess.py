...
# import data
banking_marketing_train = pd.read_csv('raw/train.csv', delimiter=';', quotechar='"')
banking_marketing_test = pd.read_csv('raw/test.csv', delimiter=';', quotechar='"')
...
# Conversion Binary
banking_marketing_train_encoded['conversion_binary'] = banking_marketing_train['y'].apply(lambda x: 1 if x == 'yes' else 0)
banking_marketing_test_encoded['conversion_binary'] = banking_marketing_test['y'].apply(lambda x: 1 if x == 'yes' else 0)

# Conversion Rate
banking_marketing_train_encoded['conversion_rate'] = banking_marketing_train_encoded['conversion_binary'] / banking_marketing_train_encoded['campaign']
banking_marketing_test_encoded['conversion_rate'] = banking_marketing_test_encoded['conversion_binary'] / banking_marketing_test_encoded['campaign']
